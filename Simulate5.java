...
public class Simulate5 {
    ...
    private Simulate5(Shop shop, PQ<Event> queue) {
        this.shop = shop;
        this.queue = queue;
    }

    public Simulate5(int numServers, List<Pair<Double, Supplier<Double>>> inputTimes) {
    ...
    public String run() {
        ...
        Simulate5 newSimulate = new Simulate5(updatedShop, newPQ); 
