...
public class Simulate4 {
    ...
    private Simulate4(Shop shop, PQ<Event> queue) {
        this.shop = shop;
        this.queue = queue; 
    }

    public Simulate4(int numServers, List<Double> arrivalTimes) {
    ...
    public String run() {
        ...
        Simulate4 newSimulate = new Simulate4(updatedShop, newPQ); 
